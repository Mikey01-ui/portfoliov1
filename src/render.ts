...
function renderIntroHeroPanel(): string {
  return `
      <div class="intro-mask js-intro-mask intro-hero js-intro-hero" aria-hidden="true">
            ...
            <div class="intro-hero__name-row">
              ...
              <div class="intro-hero__portrait-block">
                <p class="intro-hero__tagline js-intro-hero-tagline">
                  <span class="intro-hero__tagline-arrow" aria-hidden="true">↙</span>
...
export function renderApp(): string {
  ...
  const cards = projects
    .map(
      (p, i) => `
    <article class="project-card js-card" data-index="${i}" data-project-id="${escapeAttr(p.id)}">
  ...
  const showLink = Boolean(first.url);
  const linkHref = showLink && first.url ? escapeAttr(first.url) : "#";

  return `
<header class="site-header js-site-header" aria-hidden="true">
...
<section class="intro js-intro" aria-label="Intro">
  <div class="intro__pin">
    <div class="intro-stage js-intro-stage">
      ...
      <div class="intro-pixel-yo js-intro-pixel-yo" aria-hidden="true">
        <canvas class="intro-pixel-yo__canvas js-intro-pixel-canvas"></canvas>
...
<section class="work js-work is-locked" id="work" aria-label="Selected work">
      ...
      <div class="about__cta js-about-cta">
        <div class="about__flip js-about-flip">
          <div class="about__flip-inner js-about-flip-inner">
            ...
            <div class="about__flip-back js-about-flip-back">
              <div class="about__hire-panel">
                <div class="about__hire-panel-bar">
                  ...
                  <button type="button" class="about__form-back js-flip-close">${escapeHtml(about.cta.formBackLabel)}</button>
                </div>
                ...
                <form
                  ...
                  action="mailto:${escapeAttr(site.contactEmail)}"
                  method="post"
                  enctype="text/plain"
                >
